...
CREATE TABLE IF NOT EXISTS `zoo`.`animals` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_animals_attractions1_idx` (`attraction_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zoo`.`employee_tools` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_employee_tools_employees1_idx` (`employee_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zoo`.`animal_items` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_animal_items_animals1_idx` (`animal_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zoo`.`attraction_items` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_attraction_items_attractions1_idx` (`attractions_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zoo`.`salary_multiplier_2` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  UNIQUE INDEX `years_of_exp_UNIQUE` (`years_of_exp` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `zoo`.`animal_id_tags` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `animal_tag_id` BIGINT UNSIGNED NOT NULL,
  `animal_id` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  UNIQUE INDEX `animal_id_UNIQUE` (`animal_tag_id` ASC) VISIBLE,
  INDEX `fk_animal_id_tags_animals1_idx` (`animal_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zoo`.`department_attractions` (
  ...
  INDEX `fk_departments_has_attractions_attractions1_idx` (`attraction_id` ASC) VISIBLE,
  INDEX `fk_departments_has_attractions_departments_idx` (`department_id` ASC) VISIBLE,
